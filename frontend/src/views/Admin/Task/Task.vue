                        ...
                        <tbody>
                            <tr v-for="(task, index) in tasks" :key="task.id"
                                ...
                                <td class="px-6 py-4 flex gap-x-3">
                                    <router-link :to="{ name: 'EditTask', query: { taskId: task.id } }"
                                    ...
                                    <button type="button" @click="deleteTask(task.id)" class="text-red-600">
    ...
    methods: {
        ...
        async deleteTask(taskId) {
            if (confirm('Are you sure you want to delete?')) {
                try {
                    const response = await apiClient.post('admin/tasks/delete', {
                        taskId: taskId
                    });
