                        ...
                        <tbody>
                            <tr v-for="(user, index) in users" :key="user.id"
                                ...
                                <td class="px-6 py-4 flex gap-x-3">
                                    <router-link :to="{ name: 'EditUser', query: { userId: user.id } }"
                                    ...
                                    <button type="button" @click="deleteUser(user.id)" class="text-red-600">
    ...
    methods: {
        ...
        async deleteUser(UserId) {
            if (confirm('Are you sure you want to delete?')) {
                try {
                    const response = await apiClient.post('admin/users/delete', {
                        UserId: UserId
                    });
